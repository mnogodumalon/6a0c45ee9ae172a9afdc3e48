// Auto-generated. Per-entity form-enhancements config for "Katzen".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['besitzer', 'katzenname', 'rasse', 'farbe', 'geburtsdatum', 'geschlecht', 'impfstatus', 'besonderheiten'],
  defaults: {
    'geschlecht': { kind: 'lookup', key: 'unbekannt', label: 'Unbekannt' },
  },
  computed: {},
};
