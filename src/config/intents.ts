...
// <custom:intent-imports>
import { IconCalendarPlus, IconLogout } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-buchung', label: 'Neue Buchung', icon: IconCalendarPlus, description: 'Buchung in 4 Schritten anlegen' },
  { path: '/intents/abreise-abwickeln', label: 'Abreise abwickeln', icon: IconLogout, description: 'Abreise bestätigen und Buchung abschließen' },
  // </custom:intents>
];
